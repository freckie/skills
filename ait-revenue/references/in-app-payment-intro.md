...
description: 인앱 결제 서비스 소개와 콘솔 설정 방법을 안내해요.
---
...
![](/assets/iap-intro-1.Bga8WSfP.webp)
...
![](/assets/iap_flow_0.4bRXyCAi.webp)
...
![](/assets/iap_contract_1.-T0jEUbP.webp)
...
![](/assets/iap_contract_2.21lMM-HN.webp)

![](/resources/development/iap/iap_contract_3.webp)
...
![](/assets/iap_product_reg_1.DRCebeMb.webp)

![](/assets/iap_product_reg_2.DuAeZ5Cr.webp)
...
![](/assets/iap_product_reg_3.Ki8zY_7J.webp)
...
![](/assets/iap_console_1.BTLuTkFp.webp)
...
:::details Android 환불 방법
![환불 방법 관련 (안드로이드)](/assets/iap_refund_1.BPiOsKDU.webp)
:::

:::details iOS 환불 방법
![환불 방법 관련 (iOS)](/assets/iap_refund_2.BxnttCbp.webp)
:::

![](/assets/iap_console_2.h26WRQVr.webp)

#### 환불 요청 승인

파트너사가 환불 요청을 승인한 내역이에요. 요청을 승인하면, 앱마켓에 심사가 요청돼요.

![](/assets/iap_console_3.DdXBYotN.webp)

#### 환불 요청 반려

파트너사가 환불 요청을 반려하거나, 앱마켓에서 환불을 반려한 내역이에요.

![](/assets/iap_console_4.PujsyiCq.webp)

#### 환불 완료

앱마켓에서 환불이 완료된 내역이에요.

![](/assets/iap_console_5.BVWMga5A.webp)
...
![](/assets/iap_console_6.CtnlrCEa.webp)
...
\<FaqAccordion :items='\[
{
q: "인앱 결제 수수료는 어떻게 되나요?",
a: \`인앱 결제 수수료는 앱마켓 수수료 15% (향후 매출에 따라 변동 가능) + 토스 수수료 5%가 적용돼요.
