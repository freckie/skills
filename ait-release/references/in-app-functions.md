...
![](/assets/function_0.B95f3Nea.webp)
...
![](/assets/function_1.CBMnokcW.webp)

### 2. 빌드한 ait 파일을 업로드 해주세요.

![](/assets/function_2.DbHbd7AA.webp)

### 3. 출시하기 전에 앱 내 기능을 함께 등록해 주세요.

![](/assets/function_3.CFGAEu8B.webp)
...
* 사용자가 바로 접속 할 수 있는 기능의 이름과 이동할 **intoss://{{appName}}/pages** 를 입력해 주세요.
  * 앱에서 별도로 라우팅하고 있지 않다면 `/`를 입력하면 돼요. 인덱스(홈) 페이지로 랜딩돼요.
  * 쿼리 파라미터를 설정할 수 있어요.
...
![](/assets/function_4.D39_NIAP.webp)
...
![](/assets/function_5.CWzIaMD2.webp)

### 2. 검토 결과는 ‘앱 내 기능’ 탭에서 확인할 수 있어요.

![](/assets/function_6.BqnfnpJP.webp)

![](/assets/function_7.DvO8jSAg.webp)
